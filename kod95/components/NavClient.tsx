    ...
    <>
      <nav className={scrolled ? "scrolled" : ""}>
        <div className="nav-inner">
          ...
          <div className="nav-right">
            <a href="https://wa.me/48575633444" target="_blank" rel="noopener noreferrer" className="messenger-icon" title="WhatsApp">
            ...
            <a href="viber://chat?number=48575633444" className="messenger-icon" title="Viber">
      ...
      <div className={`mobile-menu${menuOpen ? " open" : ""}`}>
        ...
        <div style={{ display: "flex", gap: 20, marginTop: 8 }}>
          ...
          <a href="viber://chat?number=48575633444" style={{ color: "#7B3FE4" }}>
