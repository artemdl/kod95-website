    ...
    <footer style={{ background: "#080808", borderTop: "1px solid rgba(255,255,255,0.06)", padding: "60px 0 0" }}>
      <div className="container">
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gap: 48, marginBottom: 48 }} className="footer-grid">
          <div>
            ...
            <div style={{ display: "flex", gap: 10 }}>
              <a href="https://wa.me/48884398836" target="_blank" rel="noopener noreferrer" className="footer-messenger whatsapp" title="WhatsApp">
              ...
              <a href="viber://chat?number=48884398836" className="footer-messenger viber" title="Viber">
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              <a href="tel:+48884398836" className="footer-link">+48 884 398 836</a>
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.04)", padding: "16px 0", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
          <span style={{ color: "#444", fontSize: "0.78rem" }}>© 2025 KOD 95 ŁÓDŹ. Все права защищены.</span>
