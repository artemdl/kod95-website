...
function CTAButton() {
  return (
    <a href="#contact" className="btn-primary" style={{ padding: "16px 40px", fontSize: "0.85rem", animation: "ctaPulse 2s infinite" }}>
  ...
  return (
    <>
      ...
      <main>
        ...
        {/* ━━━ 4. КАК ВСЁ ПРОХОДИТ — vertical list ━━━ */}
        <section id="process" style={{ background: "#0d0d0d", padding: "100px 0" }}>
          <div className="container" style={{ maxWidth: 700 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 0, position: "relative" }}>
              {/* Vertical line */}
              <div style={{ position: "absolute", left: 28, top: 32, bottom: 32, width: 2, background: "linear-gradient(to bottom, rgba(232,93,4,0.4), rgba(232,93,4,0.1))", pointerEvents: "none" }} />
              {[
                ...
                <div key={i} className="fade-up" style={{ display: "flex", alignItems: "center", gap: 24, padding: "20px 0", animationDelay: `${i * 0.08}s` }}>
                  <div style={{ width: 56, height: 56, borderRadius: "50%", background: "rgba(232,93,4,0.12)", border: "1.5px solid rgba(232,93,4,0.3)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, zIndex: 1 }}>
                    <span className="font-display" style={{ fontSize: "1.4rem", color: "#e85d04" }}>{s.n}</span>
                  </div>
                  <h3 style={{ fontSize: "1rem", fontWeight: 600, color: "#f5f5f0", lineHeight: 1.4 }}>{s.title}</h3>
                </div>
              ))}
            </div>
          ...
          <div className="container">
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 16 }} className="benefits-grid">
              {[
                ...
                { icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#e85d04" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="9" cy="9" r="2"/><circle cx="15" cy="15" r="2"/><line x1="19" y1="5" x2="5" y2="19"/></svg>, text: "Гарантированная скидка на обновление Кода" },
              ].map((item, i) => (
                <div key={i} className="fade-up" style={{ display: "flex", alignItems: "center", gap: 16, padding: "20px 24px", background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 8, animationDelay: `${i * 0.08}s` }}>
                  ...
                  <span style={{ fontSize: "0.92rem", color: "#f5f5f0", fontWeight: 500 }}>{item.text}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <style>{`@media (max-width: 600px) { .benefits-grid { grid-template-columns: 1fr !important; } }`}</style>
        ...
        <section style={{ background: "linear-gradient(135deg, #0a0a0a 0%, #1a0800 50%, #0a0a0a 100%)", padding: "80px 0", position: "relative", overflow: "hidden" }}>
          ...
          <div className="container" style={{ position: "relative", zIndex: 1, textAlign: "center" }}>
            ...
            <div className="fade-up"><CTAButton /></div>
          </div>
        </section>


        {/* ━━━ 9. ДОПОЛНИТЕЛЬНЫЕ УСЛУГИ — like landing ━━━ */}
        <section id="services" style={{ background: "#0d0d0d", padding: "100px 0" }}>
          <div className="container">
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 24 }} className="services-grid">
              {[
                { icon: <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#e85d04" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><polyline points="9 15 11 17 15 13"/></svg>, title: "Код 95 — Категория C и D", desc: "Короткий и полный курс. Официальный польский документ европейского образца для работы водителем по всему ЕС.", href: "/uslugi#kod95-c" },
                { icon: <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#e85d04" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/><path d="M7 15h.01M11 15h2"/></svg>, title: "Чип-карта для тахографа", desc: "Электронная карта водителя — обязательный документ для работы на грузовых автомобилях в Европе.", href: "/uslugi#chip-card" },
                { icon: <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#e85d04" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="16" rx="2"/><path d="M7 8h10M7 12h6"/><circle cx="16" cy="16" r="3"/><path d="M18.5 18.5L20 20"/></svg>, title: "Замена водительских прав", desc: "Замените национальные права на польские европейского образца. Подскажем документы и ускорим процесс.", href: "/uslugi#license" },
                { icon: <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#e85d04" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/><path d="M6 12h4M14 12h4"/></svg>, title: "Трудоустройство", desc: "После получения Код 95 помогаем найти работу. Партнёрские вакансии для водителей — от 1700 € в месяц.", href: "/uslugi#jobs" },
              ].map((s, i) => (
                <div key={i} className="glass-card fade-up" style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.07)", padding: "32px 28px", borderRadius: 8, animationDelay: `${i * 0.1}s` }}>
                  <div style={{ width: 72, height: 72, borderRadius: 14, background: "rgba(232,93,4,0.1)", border: "1px solid rgba(232,93,4,0.2)", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 20 }}>
                    {s.icon}
                  </div>
                  <h3 style={{ fontSize: "1rem", fontWeight: 700, marginBottom: 12, color: "#f5f5f0" }}>{s.title}</h3>
                  <p style={{ fontSize: "0.85rem", color: "#888", lineHeight: 1.7, marginBottom: 20 }}>{s.desc}</p>
                  <Link href={s.href} style={{ display: "flex", alignItems: "center", gap: 6, color: "#e85d04", fontSize: "0.8rem", fontWeight: 600, textDecoration: "none", transition: "gap 0.2s" }} className="learn-more-link">
                    Узнать подробнее
        ...
        {/* ━━━ 10. НАША КОМАНДА — auto-scroll carousel ━━━ */}
        <section style={{ background: "#0a0a0a", padding: "100px 0" }}>
          <div className="container">
            <div style={{ textAlign: "center", marginBottom: 56 }}>
              <div className="orange-line fade-up" style={{ margin: "0 auto 16px" }} />
